...
- Header desktop e mobile: altezza compatta `52–56px`.
...
Tutti i componenti dell'interfaccia sono rettangolari o quadrati. Sono vietati
pillole, capsule, bottoni circolari, `border-radius:999px` e `50%`. Il raggio
standard è `4px`, il massimo è `6px`; fa eccezione soltanto la grafica interna
del logo GP.
...
- `.button--print` e `.button--share`: stessa altezza minima `44px`, stessa
  superficie bianca, stesso bordo, ombra e raggio `6px`; devono restare
...
| `.page-counter` | contatore fisso in basso a destra: `Pagina X di Y`; nella stampa è sostituito dal contatore reale nel margine A4. |
| `.back-to-top` | pulsante fisso quadrato in basso a sinistra, freccia `↑`, ritorno dolce all'inizio. |
