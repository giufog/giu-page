...
- raggio standard `4px`, massimo `6px` per controlli, card e sezioni;
- sono vietati pillole, capsule, pulsanti circolari e
  `border-radius: 999px` o `50%`; anche icone, numeri dei passaggi e pulsante
  torna-su usano contenitori quadrati;
...
- compaiono pillole, cerchi o raggi superiori a `6px`;
